...
#define CURLOPT_PROGRESSDATA CURLOPT_XFERINFODATA
  ...
  */
  ...
  CURLOPT(CURLOPT_HTTPBASEHEADER, CURLOPTTYPE_SLISTPOINT, 327),
   ...
   * hello to match. */
  CURLOPT(CURLOPT_SSL_ENABLE_ALPS, CURLOPTTYPE_LONG, 328),
  ...
  CURLOPT(CURLOPT_SSL_CERT_COMPRESSION, CURLOPTTYPE_STRINGPOINT, 329),

  /* Enable/disable TLS session ticket extension (RFC5077) */
  CURLOPT(CURLOPT_SSL_ENABLE_TICKET, CURLOPTTYPE_LONG, 330),
   ...
   */
  CURLOPT(CURLOPT_HTTP2_PSEUDO_HEADERS_ORDER, CURLOPTTYPE_STRINGPOINT, 331),

  /*
   * curl-impersonate:
   * Disable HTTP2 server push in the HTTP2 SETTINGS.
   */
  CURLOPT(CURLOPT_HTTP2_NO_SERVER_PUSH, CURLOPTTYPE_LONG, 332),
   ...
   */
  CURLOPT(CURLOPT_SSL_PERMUTE_EXTENSIONS, CURLOPTTYPE_LONG, 333),
