...
static const struct LongShort aliases[]= {
  ...
  {"cert-compression",         ARG_STRING,   "EI"},
  {"tls-session-ticket",       ARG_BOOL,     "EJ"},
  {"http2-pseudo-headers-order", ARG_STRING, "EK"},
  {"http2-no-server-push",     ARG_BOOL,     "EL"},
  {"tls-permute-extensions",   ARG_BOOL,     "EM"},
  {"alps",                     ARG_BOOL,     "EN"},
  {"data",                     ARG_STRING,   "d",},
